...
return function(file)
  ...
  local function comp(e,v,i,c)
    ...
    return ("(function() local t={} for %s in %s do %st[#t+1]=%s %send return t end)()")
  ...
  local fn = load(lua, file)
  if not fn then io.stderr:write(lua,"\n"); error"parse failed" end
